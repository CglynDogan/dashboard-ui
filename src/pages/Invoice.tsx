...
export default function Invoice() {
  ...
  const invoiceColumns: Column<Invoice>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div>
          <div className="font-medium text-gray-900 dark:text-white">{row.original.customerName}</div>
          <div className="text-sm text-gray-500 dark:text-gray-400">{row.original.customerEmail}</div>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center space-x-2">
          ...
          <button className="p-1 text-gray-400 hover:text-nexus-teal">
            <ArrowDownTrayIcon className="w-4 h-4" />
          </button>
          <button className="p-1 text-gray-400 hover:text-nexus-purple">
